...
type HelloRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // 客户端传递的用户名称
...
type HelloReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       string                 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // 服务器返回的问候信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
